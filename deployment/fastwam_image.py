"""Deployment-safe FastWAM three-camera composition.

This module is the canonical train/eval implementation.  It intentionally
lives outside ``starVLA.dataloader`` so simulator-only environments do not
execute the training package initializer or require Accelerate.
"""
